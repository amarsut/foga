...
export function showUnitManagementModal(unit, type, db, activeTab = 'tab-overview', allEvents = []) {
    ...
    // 3. Senaste loggar för översikten (Säkerställ att vi mappar rätt)
    const recentNotesHtml = [...notes].reverse().slice(0, 3).map(n => `
        ...
        <div class="bento-modal">
            <header class="modal-header-vision">
                ...
                <div class="header-right-actions">
                    ${hStatus === 'danger' ? `<div class="pulse-danger-badge"><i class="fas fa-radiation"></i> KÖRFÖRBUD</div>` : ''}
            ...
            <div class="fm-viewport" style="background:#fbfcfd; flex:1; overflow-y:auto;">
                    ...
                    <div class="bento-grid-modal">
                        <div class="bento-box">
                            ...
                            <div style="margin-top:10px;">
                                ${notes.length > 0 ? recentNotesHtml : '<p style="color:#ccc; font-size:0.8rem; font-style:italic;">Inga anteckningar i loggen.</p>'}
                            </div>
                        </div>
                        ...
                        <div style="display:flex; flex-direction:column; gap:15px;">
                            <div class="bento-box">
                                ...
                                <div style="display:grid; grid-template-columns: 1fr 1fr; gap:12px; margin-top:5px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-weight:700; font-size:0.85rem; color:${isInspExpired ? 'var(--fog-red)' : 'inherit'};">
                                            ${unit.nextInspection || '---'} ${isInspExpired ? '<i class="fas fa-clock" style="margin-left:3px;"></i>' : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="usage-tile-vision">
                                <div>
                                    ...
                                    <div style="font-size:1.5rem; font-weight:900;">${usagePercent}%</div>
                                </div>
                                <div style="font-size:0.65rem; text-align:right; font-weight:700; opacity:0.8;">Bokad ${activeDays}<br>av 30 dagar</div>
                            </div>
                ...
                <div id="tab-journal" class="fm-pane ${activeTab === 'tab-journal' ? 'active' : ''}" style="display:${activeTab === 'tab-journal' ? 'flex' : 'none'}; flex-direction:column; height:100%;">
                    <div id="chat-feed-v3" style="flex:1; overflow-y:auto; padding:20px;">
                        ...
                        `).join('') : '<div style="text-align:center; padding:40px; color:#ccc;">Inga journalnoteringar ännu.</div>'}
                    </div>
                    <div style="padding:15px 20px; background:white; border-top:1px solid #eee; display:flex; gap:10px; align-items:center;">
                        ...
                        <input type="text" id="chat-text-input" placeholder="Skriv i loggen..." style="flex:1; padding:10px 20px; border-radius:25px; border:1px solid #eee; outline:none; font-size:0.9rem;">
